...
export default class AccountAlbums extends PureComponent {
  ...
  componentWillMount () {
    ...
    dispatch(refreshPinnedStatusTimeline(accountId, { onlyMusics: 'album' }));
    dispatch(refreshAccountTimeline(accountId, { onlyMusics: 'album' }));
  ...
  handleScrollToBottom = debounce(() => {
    ...
    if (!isLoading && hasMore) {
      dispatch(expandAccountTimeline(accountId, { onlyMusics: 'album' }));
    }
  }, 300, { leading: true })
