...
class InitialStateSerializer < ActiveModel::Serializer
  ...
  def meta
    ...
    if object.current_account
      ...
      store[:is_user_admin]  = object.current_account.user.admin?
  ...
  def accounts
    ...
    store[object.target_account.id]  = ActiveModelSerializers::SerializableResource.new(object.target_account, serializer: REST::AccountSerializer) if object.target_account
